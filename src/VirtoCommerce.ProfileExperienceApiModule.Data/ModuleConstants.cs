namespace VirtoCommerce.ProfileExperienceApiModule.Data
{
    public static class ModuleConstants
    {
        ...
        {
            public const string Email = "Your email is not valid";
            public const string PhoneNumber = "Your phone Number is not valid";
            public const string UserName = "Your username is not valid";
        }
    }
}
